...
def start_processing(trace_dir, args):
    ...
    for idx, device in enumerate(args.devices):
        ...
        cmd += "sudo ./replay.sh -user $USER -device " + device + " -trace " + trace_path + " -output_dir " + output_dir + " -duration " + duration + " ; exit"
        # cmd += "sudo ./replay.sh -user $USER -device " + device + " -trace " + trace_path + " -output_dir " + output_dir + "; exit"
...
if __name__ == '__main__':
    ...
    parser.add_argument("-random", help="Will pick a random combination", action='store_true')
    ...
    if args.reverse:
        ...
        print("Shuffled the order of the trace dirs")
